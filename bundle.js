...
class Forecast {
    constructor(list) {
        this.list = list;
        this.currentDate = (0, dateConverter_1.getCurrentTime)().day;
        this.sinceTommorowArr = this.list.filter((i) => {
            return +(0, dateConverter_1.getCurrentTimeFromTxtDt)(i.dt_txt).day > this.currentDate
                ? true
                : false;
        });
    }
    ...
    getDataForHourlyForecast() {
        new auto_1.Chart(document.getElementById("hours"), {
            type: "line",
            data: {
                labels: this.getTwentyFourHoursData().map((item) => {
                    const { hours, minutes } = (0, dateConverter_1.getCurrentTimeFromTxtDt)(item.dt_txt);
            ...
            options: constants_1.optionsForChart
        });
    ...
    getDataForDailyForecast() {
        ...
        new auto_1.Chart(document.getElementById("days"), {
            type: "line",
            data: {
                labels: mainInfo.map((item) => {
                    const { day, month } = (0, dateConverter_1.getCurrentTimeFromTxtDt)(item.dt_txt);
                    return `${day}.${month}`;
                }),
                datasets: [
                    {
...
const getCurImageWeather = (weather, currentTime = "day") => {
    switch (weather) {
        ...
        case "Snow": {
            return constants_1.getIcons.snow;
        }
        case "Thunderstorm": {
            return constants_1.getIcons.thunder;
        }
    }
};
...
const getActualDecorateImage = (weather, currentTime, timeOfDay) => {
    switch (weather) {
        ...
        case "Thunderstorm":
            return constants_1.getImages.thunder;
        case "Clear": {
            return timeOfDay === "day" ? constants_1.getImages.sun : constants_1.getImages.moon;
        }
        case "Clouds": {
        ...
        default: {
            ...
            return constants_1.getImages.default;
        }
    }
};
exports.getActualDecorateImage = getActualDecorateImage;
...
exports.city = (0, exports.findSelector)("city");
exports.temp = (0, exports.findSelector)("celsius");
exports.typeOfWthr = (0, exports.findSelector)("type-of-weather");
...
exports.getIcons = {
    clear: sunny_svg_1.default,
    cloudyNight: cloudy_moon_png_1.default,
    clearNight: moon_svg_1.default,
    cloudySun: cloudy_sun_svg_1.default,
    thunder: thunder_svg_1.default,
    rain: rainy_svg_1.default,
    snow: snowy_svg_1.default,
    reallyCloudy: over_cloudy_sun_svg_1.default,
};
exports.getImages = {
    rain: rain_png_1.default,
    thunder: thunder_png_1.default,
    snow: snow_png_1.default,
    sun: sun_png_1.default,
    moon: moon_png_1.default,
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.mockForecast = exports.weatherData = void 0;
exports.weatherData = {
    coord: {
        lon: 10.99,
        lat: 44.34,
